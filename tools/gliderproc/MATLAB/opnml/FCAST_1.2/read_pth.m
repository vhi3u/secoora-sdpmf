...
%
%          If only one output argument is provided, READ_PTH returns
%          a structure composed of the above components.
%
...
if nargout==1
   temp=gridname;
   clear gridname
   % Despite appearences, the var gridname is returned as the 
   % structure when there is only one output argument.
   gridname=struct('gridname',temp,...
		   'ndrog',ndrog,...
		   'ndts',nts,...
		   'tsec',tsec,...
		   'pth',pth);
   clear pth nts ndrog temp
end
return
%
%        Brian O. Blanton
