...
% Delete any previous text and lines from stretchline
  ...
  tp1 = text(currrentpoint(1),currrentpoint(3),...
        ...
        'FontWeight','bold','Tag','Text1 For stretchline','HorizontalAlignment','center');
