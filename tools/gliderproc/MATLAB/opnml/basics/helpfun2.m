function helpfun2(figName,titleStr,helpStr1,helpStr2,helpStr3,helpStr4,helpStr5);
% HELPFUN2 Utility function for displaying help text conveniently.
%
%       Ned Gulley, 6-21-93
%       Copyright (c) 1984-94 by The MathWorks, Inc.
%
% July, 1995, Mod by Brian Blanton to accept generic window name
% and upto 5 pages of message text.
%

if nargin<3
   disp('3 args REQUIRED for helpfun2')
   return;
end
numPages=nargin-2;
if nargin<7,
...
[existFlag,figNumber]=figflag(figName,1);
newHelpWindowFlag=~existFlag;

if newHelpWindowFlag,
    position=get(0,'DefaultFigurePosition');
    position(3:4)=[550 450];
    figNumber=figure('Name',figName, ...
        	     'NumberTitle','off', ...
        	     'NextPlot','new', ...
		     'Visible','off', ...
		     'Position',position, ...
    ...
    %====================================
    % The CLOSE button ; changed by BOB to terminate the help window
    callbackStr=['delete(gcf)'];
%    callbackStr= ...
